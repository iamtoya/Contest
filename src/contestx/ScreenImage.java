...
public class ScreenImage
{
	...
	*/
	...
	public static void writeImage(BufferedImage image, File file, boolean forceWrite)
			throws IOException
		{
			if (file == null) return;

			int offset = file.getName().lastIndexOf( "." );
			...
			String type = file.getName().substring(offset + 1);
